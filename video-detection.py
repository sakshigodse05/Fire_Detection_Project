...
while True:
    ...
    if len(indexes) > 0:
        for i in indexes.flatten():
            ...
            # os.system("voice.mp4")
            # os.system("so.mp4")
            SENDER_EMAIL = "pmpd0583@gmail.com"
            APP_PASSWORD = "jhjx rxbf yijv ewwm"


            print("Mail Start")
            msg = EmailMessage()
            msg['Subject'] = "warning:Fire Detected.Evacuate immediately"
            msg['From'] = SENDER_EMAIL
            msg['To'] = "sakshisgodse05@gmail.com","mangeshsw0583@gmail.com"
