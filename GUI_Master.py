...
import os
import shutil  ##for video detection
...
heading = tk.Label(root,text="Fire Detection System",width=110,height=2,font=("Times New Roman",21,"italic"),bg="black",fg="white")
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model(r'abevent.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Fire Event Detected"
            color = red
        else:
            label_text = "Fire Not Detected"
            color = green
...
button5 = tk.Button(root,command = Video_Verify, text="Fire Detection", width=20,font=("Tempus Sanc ITC",15),bg="cyan",fg="black")
