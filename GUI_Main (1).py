...
#
lbl = tk.Label(root, text="Fire Detection System", font=('Elephant', 35,' bold '),bg="black",fg="red")
lbl.place(x=500, y=10)




img=ImageTk.PhotoImage(Image.open("im1.jpg"))

img2=ImageTk.PhotoImage(Image.open("im2.jpg"))

img3=ImageTk.PhotoImage(Image.open("im4.jpg"))
